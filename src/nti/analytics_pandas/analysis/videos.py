...
# -*- coding: utf-8 -*-
"""
.. $Id: videos.py 72614 2015-09-09 08:17:26Z egawati.panjei $
"""
...
class VideoEventsTimeseries(object):
	...
	def explore_ratio_of_events_over_unique_users_based_timestamp_date(self):
		...
		merge_df = explore_ratio_of_events_over_unique_users_based_timestamp_date_(events_df, 'total_video_events', unique_users_df)
		return merge_df
