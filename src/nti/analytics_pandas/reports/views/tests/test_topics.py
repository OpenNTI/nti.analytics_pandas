...
from nti.analytics_pandas.reports.views.topics import View
from nti.analytics_pandas.reports.views.topics import Context
...
class TestNoteEvents(AnalyticsPandasTestBase):
	...
	def test_generate_pdf_from_rml(self):
		...
		assert_that(view.options['data'].keys(), has_item('topics_created'))
