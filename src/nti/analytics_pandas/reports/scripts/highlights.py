...
# -*- coding: utf-8 -*
"""
.. $Id: highlights.py 77907 2015-11-30 16:28:37Z carlos.sanchez $
"""
...
def main():
	...
	filepath = '%s/highlights.pdf' %(args['output'])
	
	report_generator = Report(Context = HighlightsTimeseriesContext, 
