...
# -*- coding: utf-8 -*
"""
.. $Id: db_connection.py 70252 2015-08-10 15:22:32Z egawati.panjei $
"""
...
from ..utils.string_utilities import StringFolder

def create_engine_mysql(db_user='root', pwd=None, host='localhost', port='3306', db_name = 'Analytics'):
	"""
